...
type Lang="ar"|"en"; type Level=1|2|3; type Modal="video"|"gallery"|"details"|"showcase"|"hospitality"|"trust"|"testimonial"|"testimonialVideo"|"comprehensive"|null; type Section="home"|"packages"|"testimonials"|"videos"|"team"|"hospitality"; type ComprehensivePhase="idle"|"activating"|"panel";
const packs={
...
export default function Home(){
  ...
  const selectComprehensiveService=(index:number)=>{if(comprehensiveTimer.current)clearTimeout(comprehensiveTimer.current);setActiveComprehensive(index);setComprehensivePhase("activating");comprehensiveTimer.current=window.setTimeout(()=>setComprehensivePhase("panel"),760)};
